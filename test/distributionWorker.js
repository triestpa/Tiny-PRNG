...
function getPsuedoRandomValue () {
  ...
  let seed = Math.floor(Math.random() * (10 ** 12))
  const generator = new PRNG(seed)
  return generator.nextBoundedInt(0, max)
}
...
// Send data to UI thread after every 5,000,000 numbers
const postInterval = 5 * (10 ** 6)
